...
public class TestSpeedMetric {
	...
	/**
	 * Test method for {@link main.java.analysis.SpeedMetric#getMetricName()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link main.java.analysis.SpeedMetric#apply(java.util.Collection, java.util.Collection)}.
	 */
	@Test
	...
	private WebsiteResult getMockedWebsiteResult(int websiteId, int states, String url, float duration) {
